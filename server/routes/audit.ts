import { SubjectType as CoreSubjectType } from '@ministryofjustice/hmpps-audit-client'

export enum Page {
  VIEW_DPS_USER = 'VIEW_DPS_USER',
  VIEW_EXTERNAL_USER = 'VIEW_EXTERNAL_USER',
  VIEW_ALLOW_LIST_USER = 'VIEW_ALLOW_LIST_USER',
...
export type SubjectType = 'EMAIL_DOMAIN_ID' | 'GROUP_CODE' | 'ROLE_CODE' | CoreSubjectType
...
export enum EventType {
  ...
  UPDATE_ALLOW_LIST_USER = 'UPDATE_ALLOW_LIST_USER',
}
